...
# Quartile-Based Predictor Tiering

Generate a standard set of sector-specific quartiles for model prediction.  This ensures tiers are derived relative to the sample and not the adequacy cutoffs I used to create the response variable.
